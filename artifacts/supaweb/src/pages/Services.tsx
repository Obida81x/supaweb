        ...
        <div className="max-w-4xl mx-auto px-6 text-center">
          <FadeIn>
            <div className="glass rounded-3xl p-12 glow">
              <h2 className="text-3xl sm:text-4xl font-serif font-bold mb-4">{t.services.ctaTitle}</h2>
              <p className="text-zinc-400 mb-8">{t.services.ctaSubtitle}</p>
              <Link href="/contact" className="inline-flex items-center gap-2 px-8 py-4 rounded-xl bg-violet-600 hover:bg-violet-500 text-white font-semibold transition-all duration-200 glow-sm">
                {t.services.ctaButton} <ArrowRight className="w-5 h-5 rtl:rotate-180" />
              </Link>
            </div>
          </FadeIn>
        </div>
